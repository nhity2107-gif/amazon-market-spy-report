...
class DashboardV2Tests(unittest.TestCase):
    ...
    def test_visual_product_previews_exist_without_replacing_v2_workflow(self) -> None:
        ...
        self.assertIn("competitor-explorer-layout", competitor_html)
        self.assertIn("grid-template-columns: minmax(500px, 2fr) minmax(0, 3fr)", competitor_html)
        self.assertIn("grid-template-columns: repeat(5, minmax(0, 1fr))", competitor_html)
        self.assertIn("max-height: calc(100vh - 84px)", competitor_html)
        self.assertIn("overflow-y: auto", competitor_html)
        self.assertIn("scrollbar-gutter: stable", competitor_html)
        self.assertIn("table-layout: fixed", competitor_html)
        ...
        self.assertIn("gap: 22px 14px", competitor_html)
        self.assertIn("padding: 0 2px 4px", competitor_html)
        self.assertIn("line-height: 1.35", competitor_html)
