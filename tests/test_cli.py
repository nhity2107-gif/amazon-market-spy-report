...
class CliTests(unittest.TestCase):
    ...
    def test_scan_offline_writes_outputs(self) -> None:
        ...
        self.assertEqual(rows[0]["is_pod"], "maybe")
        ...
        self.assertEqual(comparison_rows[0]["is_pod"], "maybe")
        ...
        self.assertEqual(comparison_rows[0]["opportunity_score"], "45")
        self.assertEqual(comparison_rows[0]["pod_component"], "0")
        ...
        self.assertIn("No competitor products found.", seller_intelligence_page_html)
        ...
        self.assertEqual(seller_rows[0]["momentum_score"], "45")
        self.assertEqual(seller_rows[0]["pod_products"], "0")
        self.assertEqual(seller_rows[0]["pod_opportunities"], "0")
        self.assertEqual(seller_rows[0]["pod_momentum_score"], "0")
        ...
        self.assertNotIn("Personalized Mug", niche_sheet_xml)
